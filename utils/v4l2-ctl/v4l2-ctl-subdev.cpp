...
void subdev_cmd(int ch, char *optarg)
{
	...
	case OptListSubDevMBusCodes:
		...
		while (subs && *subs != '\0') {
			...
			case 0:
				list_mbus_codes_pad = strtoul(value, 0L, 0);
				break;
			case 1:
				list_mbus_codes_stream = strtoul(value, 0L, 0);
				break;
			default:
				subdev_usage();
	...
	case OptListSubDevFrameSizes:
		...
		while (*subs != '\0') {
			...
			case 0:
				...
				break;
			case 1:
				frmsize.stream = strtoul(value, 0L, 0);
				break;
			case 2:
	...
	case OptListSubDevFrameIntervals:
		...
		while (*subs != '\0') {
			...
			case 0:
				...
				break;
			case 1:
				frmival.stream = strtoul(value, 0L, 0);
				break;
			case 2:
	...
	case OptGetSubDevFormat:
		...
		while (subs && *subs != '\0') {
			...
			switch (parse_subopt(&subs, subopts, &value)) {
			case 0:
				get_fmt_pad = strtoul(value, 0L, 0);
				break;
			case 1:
				get_fmt_stream = strtoul(value, 0L, 0);
				break;
			default:
				subdev_usage();
				std::exit(EXIT_FAILURE);
	...
	case OptGetSubDevSelection:
		...
		while (*subs != '\0') {
			...
			case 0:
				...
				break;
			case 1:
				get_sel_stream = strtoul(value, 0L, 0);
				break;
			case 2:
	...
	case OptGetSubDevFPS:
		...
		while (subs && *subs != '\0') {
			...
			switch (parse_subopt(&subs, subopts, &value)) {
			case 0:
				get_fps_pad = strtoul(value, 0L, 0);
				break;
			case 1:
				get_fps_stream = strtoul(value, 0L, 0);
				break;
			default:
				subdev_usage();
				std::exit(EXIT_FAILURE);
	...
	case OptTrySubDevFormat:
		...
		while (*subs != '\0') {
			...
			case 9:
				...
				break;
			case 10:
				set_fmt_stream = strtoul(value, 0L, 0);
				break;
			default:
	...
	case OptTrySubDevSelection:
		...
		while (*subs != '\0') {
			...
			case 6:
				...
				break;
			case 7:
				vsel.stream = strtoul(value, 0L, 0);
				break;
			default:
				fprintf(stderr, "Unknown option\n");
				subdev_usage();
	...
	case OptSetSubDevFPS:
		...
		while (*subs != '\0') {
			...
			case 0:
				...
				break;
			case 1:
				set_fps_stream = strtoul(value, 0L, 0);
				break;
			case 2:
